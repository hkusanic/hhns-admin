...
class SadhanaView extends React.Component {
  constructor(props) {
    super(props)
  ...
  getSadhanaDetails = index => {
    const tempArray = JSON.parse(sessionStorage.getItem('singleUserSadhanaArray'))
    let tempObject = {}
      ...
      <React.Fragment>
        <div className="container headerDiv">
          ...
          <div className="col-lg-3 pl-5">
            <span>{formatDate(new Date(editSadhana.creation_date_time))}</span>
          </div>
